...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'user_app_customuser', 'profile_img',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='profile img', null=True, on_delete=models.SET_NULL, to=orm['cicu.UploadedFile']),
                      keep_default=False)
    ...
    models = {
        ...
        u'user_app.customuser': {
            ...
            'profile_img': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'profile img'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['cicu.UploadedFile']"}),
