...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'user_app_certifications', (
        ...
        db.send_create_signal(u'user_app', ['Certifications'])
        ...
        # Deleting field 'CustomUser.profile_img'
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'user_app_certifications')
        ...
        # Adding field 'CustomUser.profile_img'
        db.add_column(u'user_app_customuser', 'profile_img',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='profile img', null=True, to=orm['cicu.UploadedFile'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
