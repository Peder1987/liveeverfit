...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Professional.queue'
        db.delete_column(u'user_app_professional', 'queue')


    def backwards(self, orm):
        # Adding field 'Professional.queue'
        db.add_column(u'user_app_professional', 'queue',
