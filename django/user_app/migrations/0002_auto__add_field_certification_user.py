...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Certification.user'
        db.add_column(u'user_app_certification', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='certification', null=True, to=orm['user_app.CustomUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Certification.user'
        db.delete_column(u'user_app_certification', 'user_id')
    ...
    models = {
        ...
        u'user_app.certification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'certification'", 'null': 'True', 'to': u"orm['user_app.CustomUser']"})
        },
