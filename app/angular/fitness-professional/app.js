    ...
    app.register.controller("fitness-professionalCtrl", ["$scope", "$resource", "rest", "tokenError", "specialtyTags",
        function ($scope, $resource) {
            ...
            $scope.filter = function () {
                $scope.professionals = filterProfessionalCollection.get({
